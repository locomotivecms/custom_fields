...
# module CustomFieldsCarrierwaveExtension
#   def mount_uploader(column, uploader=nil, options={}, &block)
#     super(column, uploader, options, &block)
#
#     mount_uploader_with_localization(column, uploader, options, &block)
#   end
#
#   private
#
...
# end
#
# ::CarrierWave::Mongoid.send(:prepend, CustomFieldsCarrierwaveExtension)
